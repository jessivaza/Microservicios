...
public class ControladorUsuario {
    ...
    // --- LEER POR EMAIL (GET /api/usuarios/email/{email}) ---
    ...
    public ResponseEntity<?> actualizarUsuario(@PathVariable Long id, @RequestBody Usuario datosActualizados) {
        ...
        if (datosActualizados.getNombres() != null) usuarioExistente.setNombres(datosActualizados.getNombres());
        if (datosActualizados.getApellidos() != null) usuarioExistente.setApellidos(datosActualizados.getApellidos());
        if (datosActualizados.getRolId() != null) usuarioExistente.setRolId(datosActualizados.getRolId());
